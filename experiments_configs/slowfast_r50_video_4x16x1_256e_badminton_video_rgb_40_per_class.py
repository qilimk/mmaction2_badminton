...
ann_file_train = 'badminton_dataset_ncu_train_labels.txt'
...
data = dict(
    ...
    train=dict(
        type='VideoDataset',
        ann_file='badminton_dataset_ncu_train_labels.txt',
...
lr_config = dict(
    ...
    warmup_iters=34)
total_epochs = 50
work_dir = './experiments/slowfast_r50_video_4x16x1_256e_badminton_video_rgb_40_per_class'
