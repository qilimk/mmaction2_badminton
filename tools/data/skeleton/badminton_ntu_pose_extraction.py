...
args.det_config = '/home/jovyan/local/mmaction2_badminton/demo/demo_configs/faster-rcnn_r50-caffe_fpn_ms-1x_coco-person.py'  # noqa: E501
...
args.pose_config = '/home/jovyan/local/mmaction2_badminton/demo/demo_configs/td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'  # noqa: E501
...
def ntu_pose_extraction(vid, skip_postproc=False):
    ...
    anno['label'] =  int(osp.splitext(osp.basename(vid))[0].split('_')[-1])
    tmp_dir.cleanup()
...
def parse_args():
    ...
    parser.add_argument('--anno_file', type=str, default='/home/jovyan/local/mmaction2_badminton/badminton_dataset_ncu_coach_test_labels.txt')
...
if __name__ == '__main__':
    ...
    anno_file = global_args.anno_file
    data_dir = '/home/jovyan/local/mmaction2_badminton/badminton_dataset_for_classification_ncu_coach_ver_final/'

    data_name = f"{anno_file.split('.')[0]}_data.pkl"
    data_to_save = []
    ...
    with open(anno_file) as f:
        ...
        for l in lines:
            ...
            video_path = osp.join(data_dir,f'{video_name}')
            print(video_path)
            anno = ntu_pose_extraction(video_path, args.skip_postproc)
            data_to_save.append(anno)

    mmengine.dump(data_to_save, data_name)
