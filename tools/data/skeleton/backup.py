...
def parse_args():
    ...
    parser.add_argument('--anno_file', type=str, default='test.txt')
...
if __name__ == '__main__':
    ...
    data_dir = '/home/jovyan/local/mmaction2/badminton_dataset_for_classification_ncu_coach_ver_final/'
    ...
    mmcv.dump(data_to_save, data_name)
